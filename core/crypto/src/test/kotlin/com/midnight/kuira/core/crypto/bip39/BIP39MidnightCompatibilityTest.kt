...
class BIP39MidnightCompatibilityTest {
    ...
    companion object {
         ...
         * Generated by official Midnight SDK with 32-byte truncation:
         * - @scure/bip39 v1.5.4 (used by @midnight-ntwrk/wallet-sdk-hd)
         * - mnemonicToSeed(mnemonic, '', wordlist).subarray(0, 32)
         *
         * Full 64-byte seed would be: 3397b06b...59a98e8d[e7c7be63...108b9ece]
         ...
         * Generated by official Midnight SDK with 32-byte truncation:
         * - @scure/bip39 v1.5.4
         * - mnemonicToSeed(mnemonic, 'TREZOR', wordlist).subarray(0, 32)
         *
         * Full 64-byte seed would be: 91496f14...d3f96dd1[99fb417a...47d7fd85]
         * Verified Date: 2026-01-13
         */
